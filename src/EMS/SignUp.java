...
public class SignUp extends javax.swing.JFrame {
    ...
    private void RegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterActionPerformed
        ...
        switch (role) {
            case 1:
                Customer cust = new Customer();
                 result = cust.createAccount(email, pass, phone, addr, role);
                if (result == 1) {
        ...
        if(result ==1){
        JOptionPane.showMessageDialog(null, "Please Login to Proceed", "Success", JOptionPane.INFORMATION_MESSAGE);
